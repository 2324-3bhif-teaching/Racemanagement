...
[%collapsible]
====
image::images/MockupHome.png[]
Links soll eine Liste mit den verfügbaren Autos sein.
Indem man ein Auto auswählt und auf den "+" Button drückt öffnet sich das Menü zum Mappen(siehe MapMenü Mockup).
Oben rechts befindet sich ein Button zum Downloaden einer EXCEL datei mit den gemappten Daten.
====

.Map Menü
[%collapsible]
====
image::images/MapMenue.png[]
Drückt man auf den "+" Button bekommt man nun eine Auswahl an Steuergeräten die man mit den Autos mappen kann.
Man wählt ein Gerät aus und drückt den Map Button um den Vorgang abzuschließen.
...
Programmiersprache: Typescript,HTML
